...
r = 1
s = 1e-8
fit [strptime("%Y%m%d","20190101"):strptime("%Y%m%d","20200101")] h(x) "walk.csv" u 1:3 via r,s
...
"WeightTargets.csv"	       using 1:2 axes x1y1 with lines ls 8 dt 3 title "Weight Target", \
